...
?>
<div class="checkout__verify">
	<div class="container">
		<form name="checkout" method="post" class="woocommerce-form woocommerce-verify-email light-form" action="<?php echo esc_url( $verify_url ); ?>" enctype="multipart/form-data">
			...
			?>
			<p class="checkout__verify-notice">
				<?php
				printf(
			...
			<div class="checkout__verify-form inline-form">
				<div class="inline-form__field">
					<label class="screen-reader-text" for="email"><?php esc_html_e( 'Email address', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
					<input type="email" class="input-text" name="email" id="email" autocomplete="email" placeholder="<?php esc_html_e( 'Email address', 'woocommerce' ); ?>*" />
				</div>

				<button type="submit" class="inline-form__button woocommerce-button button <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ); ?>" name="verify" value="1">
