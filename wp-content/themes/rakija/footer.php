			...
			<div class="container">
				...
				<div class="site-footer__top-right">
					...
					<div class="social-box">
						<h5>Pratite nas</h5>
						<a href="https://www.facebook.com/rakijahouse1" target="_blank">fb icon here</a>
						<a href="https://www.instagram.com/rakija_house/" target="_blank">ig icon here</a>
					</div>
				</div>
			</div>
		</div>
